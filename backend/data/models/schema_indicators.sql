...
CREATE TABLE IF NOT EXISTS indicator_parameters (
    ...
    param_name TEXT NOT NULL,       -- Name of the parameter (e.g., "period", "multiplier")
    param_type TEXT NOT NULL,       -- Type of the parameter (e.g., "integer", "float", "boolean")
...
CREATE TABLE IF NOT EXISTS instrument_indicator_results (
    ...
    indicator_id INTEGER NOT NULL,      -- Foreign key to indicators table
    param_id INTEGER NOT NULL,          -- Foreign key to indicator_parameters table
    param_name TEXT, -- Foreign key to indicator_parameters table
    param_value REAL NOT NULL,          -- Value of the parameter (calculated or used)
